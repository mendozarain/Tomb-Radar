...
public class cameratest extends AppCompatActivity {
    ...
    public void EnableRuntimePermissionToAccessCamera(){
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(cameratest.this,
                Manifest.permission.CAMERA))
        {

            // Printing toast message after enabling runtime permission.
            Toast.makeText(cameratest.this,"CAMERA permission allows us to Access CAMERA app", Toast.LENGTH_LONG).show();

        } else {

            ActivityCompat.requestPermissions(cameratest.this,new String[]{Manifest.permission.CAMERA}, RequestPermissionCode);
    ...
    public void ImageUploadToServerFunction(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(cameratest.this,"Image is Uploading","Please Wait",false,false);
            }
            ...
            protected void onPostExecute(String string1) {
                ...
                Toast.makeText(cameratest.this,string1,Toast.LENGTH_LONG).show();
        ...
        switch (RC) {
            ...
            case RequestPermissionCode:
                ...
                if (PResult.length > 0 && PResult[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(cameratest.this,"Permission Granted, Now your application can access CAMERA.", Toast.LENGTH_LONG).show();

                } else {

                    Toast.makeText(cameratest.this,"Permission Canceled, Now your application cannot access CAMERA.", Toast.LENGTH_LONG).show();
